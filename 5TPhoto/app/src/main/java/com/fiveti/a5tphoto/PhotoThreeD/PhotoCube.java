...
public class PhotoCube {
    ...
    public PhotoCube(Context context, ArrayList<String> list) {
        //Load ảnh
        ...
        for (int face = 0; face < numFaces; face++) {
            File imgFile=new File(list.get(face).toString());

            bitmap[face] = BitmapFactory.decodeFile(imgFile.getAbsolutePath());
