...
import com.fiveti.a5tphoto.Activity.SelectImg3d;
...
public class SelectImg3dAdapter extends ArrayAdapter<Album> {
    ...
    public SelectImg3dAdapter(Context context, ArrayList<Album> allPath, int int_position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.selectImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SelectImg3d.prepareSelection(v, position);
            }
        });
